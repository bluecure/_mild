...
class Customizer {
    ...
    public function load_customizer_scripts() {
        ...
        wp_enqueue_script('bow-customizer', get_template_directory_uri() . '/assets/scripts/admin/customizer.js', [
            'jquery',
            'customize-preview'
        ], '1.0.0', true);
    ...
    public function load_control_scripts() {
        ...
        wp_enqueue_script('bow-controls', get_template_directory_uri() . '/assets/scripts/admin/controls.js', [ 'jquery' ], '1.0.0', true);
