...
add_action('after_setup_theme', function() {
	...
	add_image_size( 'tile', 500, 500, true );
...
add_action('wp_enqueue_scripts', function() {
    ...
    // Load main css file
    wp_enqueue_style('bow-styles', get_template_directory_uri() . '/assets/styles/style.css', [], '1.0.0');
    // Load main js file
 ...
 */
add_action('wp_enqueue_scripts', [ Template::class, 'customizer_styles' ]);
